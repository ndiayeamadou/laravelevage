...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Mon Profil')
        ...
        <div class="pd-20 card-box height-100-p">
            <div class="profile-photo">
                ...
                <img
                    ...
                    id="adminProfilePicture" class="avatar-photo" alt=""
                />
                <input type="file" name="adminProfilePictureFile" id="adminProfilePictureFile" class="d-none" style="opacity: 0">
            </div>
            <h5 class="text-center h5 mb-0" id="adminProfileName">{{ $adminUser->name }}</h5>
            ...
            <div class="profile-info">
                ...
                <ul>
                    <li>
                        ...
                        <p id="adminProfileEmail">{{ $adminUser->email }}</p>
                    </li>
                    <li>
